package racoonsoft.investmentwheel.settings;
...
import racoonsoft.investmentwheel.interceptor.AccessInterceptor;
import racoonsoft.investmentwheel.interceptor.HistoryInterceptor;
import racoonsoft.library.sms.SMSProcessor;

@Configuration
@Import({WebConfig.class })
@ComponentScan(basePackages = "racoonsoft.investmentwheel")
public class MainConfig extends WebMvcConfigurerAdapter
{
	...
	public static PropertySourcesPlaceholderConfigurer propertySourcesPlaceholderConfigurer()
    {
        ...
        Resource[] resources = new ClassPathResource[ ]
                { new ClassPathResource( "/racoonsoft/investmentwheel/properties/main.properties" ) };
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        InterceptorRegistration accessInterceptor = registry.addInterceptor(history);
        historyInterceptor.addPathPatterns("/api/**");
        historyInterceptor.addPathPatterns("/admin/**");
