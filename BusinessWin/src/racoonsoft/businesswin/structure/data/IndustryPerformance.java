...
public class IndustryPerformance
{
    ...
    public EconomicsValue industry_profit_after_taxes = new EconomicsValue(1.0, 999.0, 2, 1.0);

    @DataStructureField(name="total_revenue", description="Суммарная выручка")
    public EconomicsValue total_revenue = new EconomicsValue(1.0, 999.0, 2, 1.0);

    @DataStructureField(name="sell_price", description="Цена продаж")
    public EconomicsValue sell_price = new EconomicsValue(1.0, 999.0, 2, 1.0);

    @DataStructureField(name="industry_profit_change", description="Изменение прибыли отрасли")
    public EconomicsValue industry_profit_change = new EconomicsValue(1.0, 999.0, 2, 1.0);

    @DataStructureField(name="industry_costs_change", description="Изменение затрат отрасли")
    public EconomicsValue industry_costs_change = new EconomicsValue(1.0, 999.0, 2, 1.0);

    @DataStructureField(name="taxes", description="Налоговые сборы")
    public EconomicsValue taxes = new EconomicsValue(1.0, 999.0, 2, 1.0);

    @DataStructureField(name="total_power", description="Общая можность")
    public EconomicsValue total_power = new EconomicsValue(1.0, 999.0, 2, 1.0);

    @DataStructureField(name="total_production", description="Общее производство")
    public EconomicsValue total_production = new EconomicsValue(1.0, 999.0, 2, 1.0);
    ...
    public EconomicsValue total_net_book_value_of_fixed_assets = new EconomicsValue(1.0, 999.0, 2, 1.0);

    @DataStructureField(name="accounts_balance", description="Остаток денежных средств на счетах")
    public EconomicsValue accounts_balance = new EconomicsValue(1.0, 999.0, 2, 1.0);

    @DataStructureField(name="capacity_unit_price", description="Стоимость единицы новой мощности")
    public EconomicsValue capacity_unit_price = new EconomicsValue(1.0, 999.0, 2, 1.0);

    //TODO: calculate
    @DataStructureField(name="total_production_loading", description="Общая загрузка производства")
    public EconomicsValue total_production_loading = new EconomicsValue(1.0, 999.0, 2, 1.0);
