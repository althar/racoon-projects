...
<header class="main-header">
    <nav class="main-header_inner row">
        <h1 class="main-header_logo">
            ...
            <span class="logotype_descr">Универсальный интернет-магазин</span>
        </h1>
        <div class="main-header_contacts">
            <h2 class="title_type-contact">Заказ в интернет-магазине</h2>
            <div class="contact-phones">
                <p>
                    <strong>${static_data.getStringValue('phone')}</strong> Пн-Пт  с 8.00 - 22.00
                </p>
                <p>
                    <strong>${static_data.getStringValue('free_phone')}</strong> Сб-Вс с 8.00 - 18.00
                </p>
            </div>
        </div>
    </nav>
