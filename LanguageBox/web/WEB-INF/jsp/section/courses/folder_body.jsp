...
<div class="widget-content table-container">
    <table class='table folder-body'>
        ...
        <c:forEach items="${folder.getRecords('materials')}" var="material">
            <tr class='folder-body-node library_list-item' entity-type="material"
                entity-id="${material.getLongValue('id')}" entity-category-type="${material.getStringValue('type')}"
                entity-name="${material.getStringValue('name')}">
                <td>
