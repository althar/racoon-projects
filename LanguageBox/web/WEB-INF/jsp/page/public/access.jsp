...
<body>
  ...
  <div id="login-wrap">
    ...
    <div id="login-buttons">
      <c:choose>
        <c:when test="${widget == 'registration'}">
          <div class="btn-wrap">
    ...
    <div id="login-inner" class="login-inset">
      <div id="login-circle">
        ...
        <c:choose>
          <c:when test="${widget == 'registration'}">
            <section id="register-form" class="login-inner-form" data-angle="0">
              <h1>Регистрация</h1>
          ...
          <c:otherwise>
            ...
            <section id="forget-form" class="login-inner-form" data-angle="90">
              <h1>Забыли пароль?</h1>
