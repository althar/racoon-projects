...
public final class ScanActivityHandler extends Handler {
    ...
    switch (message.what) {
      case R.id.auto_focus:
        ...
        if (state == State.PREVIEW) {
        	if (Consts.CONTINUOUS_AUTOFOCUS)
      ...
      case R.id.return_scan_result:
        ...
        activity.finish();
        break;
      case R.id.number_dialog_railroad_number:
    	break;
    }
  }
  ...
  private void restartPreviewAndDecode() {
    if (state == State.SUCCESS) {
      state = State.PREVIEW;
      cameraManager.requestPreviewFrame(decodeThread.getHandler(), R.id.decode);
      if (Consts.CONTINUOUS_AUTOFOCUS) cameraManager.requestAutoFocus(this, R.id.auto_focus);
