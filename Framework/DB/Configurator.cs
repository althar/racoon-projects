...
namespace FTwoFramework.DB
{
    public class Configurator
    {
        ...
        static Configurator()
        {
            ...
            dict.Add("delivery_time", "Время доставки");
            dict.Add("first_order", "Первый заказ клиента");
            dict.Add("total_good_price", "Общая стоимость товаров");
            dict.Add("delivery_price", "Цена доставки");
            dict.Add("discount", "Скидка");
            dict.Add("good_id", "ID товара");
            dict.Add("delivery_variant_name", "Доставки");
