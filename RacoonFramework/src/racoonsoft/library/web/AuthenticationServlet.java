...
import racoonsoft.library.access.Session;
import racoonsoft.library.access.User;
import racoonsoft.library.database.DBRecord;
import racoonsoft.library.exceptions.SessionCreationException;
...
public abstract class AuthenticationServlet extends HttpServlet
{
    ...
    {
        User u = new User(BaseServlet.dbProc().authenticateUser(login,password));
        if(u!=null)
        {
    ...
    public static String authentication_trusted(User u) throws SessionCreationException,NumberFormatException,SQLException
    {
        if(u!=null)
        {
            Long session_lifetime = 864000l;
