        ...
        <div class="container white">
            <div class="profile-goods">
                <div class="path-left">
                    ...
                    <div class="price"><span class="color">${good_short.get('Item').get('Price')}</span> теплуносов</div>
                                ...
                                <ul>
                                    <c:forEach items="${attribute.get('Detail').get('ClassAttributes')}" var="inner_attribute">
                                        ...
                                        <li class="item cleared">
                                            ...
                                            <div class="description"><%=StringHelper.getCharEncodedString(pageContext.getAttribute("attr_value_inner").toString())%></div>
                                        </li>
                                        </c:if>
                                    </c:forEach>
                                </ul>
