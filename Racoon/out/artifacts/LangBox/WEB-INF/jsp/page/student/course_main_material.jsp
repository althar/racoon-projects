...
<div class="widget span8">
    <div class="widget-header">
        <span class="title">Материал к курсу</span>
        <div class="toolbar">
            <div class="btn-group">
                <span class="btn">Словарь курса</span>
                <span class="btn">Учебники</span>
                <span class="btn">Книги</span>
                <span class="btn">Грамматика</span>
                <span class="btn">Тесты</span>
                <span class="btn">Ссылки</span>
            </div>
        </div>
    </div>
    <div class="widget-content" style="padding-top: 10px;">
        <div class="folder file active-file">Материалы к разговорному курсу<span style="margin-left: 30px;"><img src="/img/sound.png"></img></span></div>
