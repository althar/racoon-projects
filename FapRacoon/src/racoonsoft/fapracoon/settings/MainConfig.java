package racoonsoft.fapracoon.settings;
...
import racoonsoft.fapracoon.database.PGSQLDataSource;


@Configuration
@Import({WebConfig.class })
@ComponentScan(basePackages = "racoonsoft.fapracoon")
public class MainConfig extends WebMvcConfigurerAdapter {
	...
	public static PropertySourcesPlaceholderConfigurer propertySourcesPlaceholderConfigurer() {
        ...
        Resource[] resources = new ClassPathResource[ ]
                { new ClassPathResource( "/racoonsoft/fapracoon/properties/main.properties" ) };
