...
public class PGSQLDataSource extends DBProcessor
{
    ...
    public Long insertWish(String user_facebook_id,Long user_id,Long good_id,Double price,String reason,Date date,String good_name) throws SQLException
    {
    ...
    public Long insertWishToFriend(Long user_id,String user_facebook_id,Long good_id,Double price,String reason,Date date,String good_name) throws SQLException
    {
        HashMap<String,Object> params = new HashMap<String, Object>();
        params.put("user_id",user_id);
        params.put("user_facebook_id",user_facebook_id);
    ...
    public ArrayList<FacebookFriendWishList> getFriendsWishList(FacebookFriendList friends) throws SQLException
    {
        ...
        condition.append(")");
        String query = "SELECT * FROM wish_list WHERE "+condition+" ORDER BY user_facebook_id";
