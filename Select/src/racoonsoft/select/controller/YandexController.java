...
//        Заголовок: <NAME>
//            Текст объявления: <NAME>  <PRICE>! Доставка. Гарантия 5 лет.
//            Ссылка на сайт: select-st.ru/<NAME>
//            Ключевые фразы: <NAME>
        ...
        for(int i=0; i<list.size(); i++)
        {
            ...
            String link = "http://select-st.ru/%D0%A2%D0%BE%D0%B2%D0%B0%D1%80?id="+list.get(i).getLongValue("id");
